...
In order to support loading of multiple wallets in genzycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is genzycoin.cpp.
...
Changes to genzycoin.cpp
----------------------
genzycoin.cpp is the entry point into genzycoin-qt, and as such, will require some minor modifications to provide hooks for
