...
# Copyright (c) 2018 The Genzy Coin Core developers
...
#   c) node1 mines 32 blocks, so now node 0 has 60001GNZ, node 1 has 4250GNZ, node2 has none.
#   d) node0 sends 601 GNZ to node2, in two transactions (301 GNZ, then 300 GNZ).
