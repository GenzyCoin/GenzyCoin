...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/genzycoin-cli.cpp \
           src/genzycoin-tx.cpp \
           src/genzycoin.cpp \
           src/db.cpp \
           ...
           src/qt/genzycoin.cpp \
           src/qt/genzycoinstrings.cpp \
...
RESOURCES += src/qt/genzycoin.qrc src/qt/genzycoin_locale.qrc

TRANSLATIONS += src/qt/locale/genzycoin_bg.ts \
                src/qt/locale/genzycoin_de.ts \
                src/qt/locale/genzycoin_en.ts \
                src/qt/locale/genzycoin_es.ts \
                src/qt/locale/genzycoin_fi.ts \
                src/qt/locale/genzycoin_fr.ts \
                src/qt/locale/genzycoin_it.ts \
                src/qt/locale/genzycoin_ja.ts \
                src/qt/locale/genzycoin_pl.ts \
                src/qt/locale/genzycoin_pt.ts \
                src/qt/locale/genzycoin_ru.ts \
                src/qt/locale/genzycoin_sk.ts \
                src/qt/locale/genzycoin_sv.ts \
                src/qt/locale/genzycoin_vi.ts \
                src/qt/locale/genzycoin_zh_CN.ts \
                src/qt/locale/genzycoin_zh_TW.ts
