...
This means one can have an always-on genzycoind instance running, and another local genzycoind/genzycoin-qt instance which connects to this node and receives blocks from it.
