Contributing to Genzy Coin Core
===============================

The Genzy Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Genzy Coin Core project, and is not to be
confused with overall Genzy Coin Network Protocol consensus changes.

Whether a pull request is merged into Genzy Coin Core rests with the project merge
...
Patches that change Genzy Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Genzy Coin consensus, it must have been
...
The project leader is the release manager for each Genzy Coin Core release.
