...
/** Utility functions used by the Genzy Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Genzy Coin addresses in monospace font
...
// Parse "genzycoin:" URI into recipient object, return true on successful parsing
