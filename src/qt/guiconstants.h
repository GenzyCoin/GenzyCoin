...
/* Gency Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Genzy Coin"
#define QAPP_ORG_DOMAIN "genzycoin.org"
#define QAPP_APP_NAME_DEFAULT "GenzyCoin-Qt"
#define QAPP_APP_NAME_TESTNET "GenzyCoin-Qt-testnet"
