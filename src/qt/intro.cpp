...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Genzy Coin Core"),
     ...
     * override -datadir in the genzycoin.conf file in the default data directory
     * (to be consistent with genzycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
