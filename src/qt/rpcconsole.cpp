                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGNZPathCustom = GetArg("-zgnzbackuppath", "");
    ...
    if(!strzGNZPathCustom.empty()) {
        ui->wallet_customzgnzbackuppath->setText(QString::fromStdString(strzGNZPathCustom));
        ui->wallet_customzgnzbackuppath_label->setVisible(true);
        ui->wallet_customzgnzbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGNZPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Genzy Coin RPC console.") + "<br>" +
