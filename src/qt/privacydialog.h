...
public:
    ...
    void setZGnzControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGNZ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGNZ_clicked();
    void on_pushButtonZGnzControl_clicked();
