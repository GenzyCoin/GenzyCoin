...
/**
 * CChainParams defines various tweakable parameters of a given instance of
 * the Genzy Coin system.
 * There are three: the main network on which people trade goods
