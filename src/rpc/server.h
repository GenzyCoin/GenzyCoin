...
/**
 * Genzy Coin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzgnzseed(const UniValue& params, bool fHelp);
extern UniValue getzgnzseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgnz(const UniValue& params, bool fHelp);
extern UniValue dzgnzstate(const UniValue& params, bool fHelp);
