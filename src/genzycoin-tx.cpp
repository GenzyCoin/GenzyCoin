...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Genzy Coin Core genzycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  genzycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded genzycoin transaction") + "\n" +
                               "  genzycoin-tx [options] -create [commands]   " + _("Create hex-encoded genzycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded genzycoin transaction
